...
--
-- Host: localhost
-- Generation Time: 2017-01-18 12:29:41
...
INSERT INTO `Discussion` (`id`, `topic`, `answer`, `fenzhi`, `time`) VALUES
...
(1, '测试', 2, 2, 2, '2017-01-16 10:59:23', '');
...
(1, '高等教育的任务是培养具有____和实践能力的高级专门人才，发展科学技术文化，促进社会主义现代化建设。', '冒险精神', '创新精神', '求知精神', '独立精神', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(2, '《普通高等学校学生管理规定》规定，学生应征参加中国人民解放军（含中国人民武装警察部队），学校应当保留其学籍 （  ）', '一年', '至退役后一年', '两年', '至退役后两年', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(3, '高等学校实行教师聘任制。高等学校的教师的聘任，应当遵循双方 ____ 原则，由高等学校校长与受聘教师签订聘任合同', '独立自主', '真诚守信', '平等自愿', '公平公正', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(4, '接受非学历高等教育的学生，成绩合格，由所在高等学校或者其他高等教育机构发给相应的 (__)。', '结业证书', '学习证明', '肄业证书', '毕业证书', 'A', 2, 0, 0, '2017-01-17 05:21:30'),
(5, '高等学校应当以(  )为中心，保证教育教学质量达到国家规定的标准。', '开展教育', '社会服务', '科学研究', '培养人才', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(6, '2012年3月6日，温家宝总理在政府工作报告中明确提出，2012年要确保全国财政性教育经费支出占国内生产总值（GDP） ____ 的目标。', '0.03', '0.04', '0.05', '0.06', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(7, '入学教育的重点是适应性教育。以下不属于入学教育主要内容的是 ____。', '爱校教育', '专业思想教育', '基本理论教育', '理想信念教育', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(8, '学生社团在校园文化建设中发挥着特殊的作用，更因其以学生为主体而在育人体系中占据重要位置。关于学生社团的主要作用以下描述正确的是____。', '① 有利于提高学生综合素质② 有利于繁荣校园文化③ 有利于规范学生日常行为', '① 有利于提高学生综合素质② 有利于繁荣校园文化④ 有利于社会主义政治文明建设', '② 有利于繁荣校园文化③ 有利于规范学生日常行为④ 有利于社会主义政治文明建设', '① 有利于提高学生综合素质 ② 有利于繁荣校园文化③ 有利于规范学生日常行为④ 有利于社会主义政治文明建设', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(9, '“关爱自然，爱护环境，珍惜资源”属于《高等学校学生行为准则》内容中的哪一条准则？ (__)', '热爱祖国，服务人民', '遵纪守法，弘扬正气', '明礼修身，团结友爱', '强健体魄，热爱生活', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(10, '关于建立健全一套科学完整、长期有效的学生紧急事件预警防控机制，下列说法不正确的是___。', '建立组织有力、运转高效、职责分明的组织机构，形成及时、快捷、通畅的信息网络', '树立“管了没用也要管”、“说了不听也要说”的观念，但对于防不胜防的突发紧急事件，属于工作之外无法把握的，故不必采取相应措施', '构建心理预警机制，制定紧急事件应急处理方案', '健全日常工作机制，保证信息采集渠道通畅，辅导员应保持全天候信息通畅。', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(11, '在实际工作中，辅导员不可能对某些理论问题有深入的研究，为解答学生的困惑，辅导员可以借助专家的力量来满足学生的需求。辅导员在此扮演的是____角色。', '解惑者', '管理者', '中介', '组织者', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(12, '从简单分类来讲，辅导员属于___教师。', '德育', '智育', '任课', '管理', 'A', 2, 0, 0, '2017-01-17 05:21:30'),
(13, '班级信息管理的主要途径有人脉系统、书面系统和网络系统，下列属于书面系统的是 ___ 。', '学生的思想汇报', '班会通知', 'E-mail通知', '电话通知', 'A', 2, 0, 0, '2017-01-17 05:21:30'),
(14, '新时期辅导员在工作中应坚持的工作理念是 ___。', '管理为主，教育为辅', '为学生服务理念', '教育为主，管理为辅', '学生自主发展', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(15, '高校素质教育中，思想道德素质是___。', '核心和关键', '基本条件', '方向和灵魂', '基础', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(16, '在高校班级班委队伍的组建中，下列哪项是以辅导员指定方式任命的班委的优点____？', '群众认可度较高', '班委之间的和谐度较高', '有利于竞争', '保证班委质量', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(17, '下列关于大学生职业生涯辅导的主要内容描述全面且正确的有____', '①认识自我③职业决策 ④提升求职技巧 ⑤了解就业政策', '①认识自我 ②认识职业环境④提升求职技巧 ⑤了解就业政策', '①认识自我 ②认识职业环境 ③职业决策⑤了解就业政策', '①认识自我 ②认识职业环境 ③职业决策 ④提升求职技巧 ⑤了解就业政策', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(18, '亲人死亡、失恋、学业失败等造成的心理危机，属于心理危机类型中的 ____', '发展性危机', '现实性危机', '存在性危机', '情境性危机', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(19, '2012年3月5日是学习雷锋纪念日多少周年？______', '48', '49', '50', '51', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(20, '国家鼓励毕业生到基层就业的优惠政策不包括______', '按照规定给予社会保险补贴和公益性岗位补贴；', '给予薪酬或生活补贴，同时按规定参加有关社会保险；', '按规定实施相应的学费补偿和国家助学贷款代偿；', '在研究生招录和事业单位选聘时实行笔试免试', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(21, '下面那个不属于选聘到村任职的一般程序？____下列关于心理咨询主要形式说法不正确的是____', '个体咨询是心理咨询最主要的形式，它在咨询者与求询者之间建立了一对一的关系。 ', '团体咨询多用于解决一般性的表层心理咨询问题，如恋爱问题、时间管理、人际交往问题。', '电话咨询能够有效降低咨询者的顾虑，具有保密性，能够深入彻底解决心理问题。', '书信咨询对那些不愿意或者不方便与咨询者面谈的求询者较为适用。', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(22, '国家鼓励高校毕业生应征入伍，下面哪一类毕业生属于这里的界定“高校毕业生”？_________', '往届毕业生；', '成人高等教育；', '民办普通高等学校；', '高等教育自学考试类学生', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(23, '下列选项中，哪一个不属于毕业生应征入伍服义务兵役享受哪些优惠政策?________', '优先报名应征、优先体检政审、优先审批定兵', '优先选拔使用', '补偿学费或代偿国家助学贷款', '优先推荐上高一层次学校', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(24, '人的生理和心理发展趋于成熟的关键时期是 ________ 。', '初中时期', '高中时期', '大学时期', '成年期', 'C', 2, 0, 0, '2017-01-17 05:21:30'),
(25, '21世纪成为人才的首要条件是 ______。', '身体健康', '心理健康', '社会适应良好', '人际关系良好', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(26, '大学作为一个特殊的群体,衡量大学生心理健康的首要为____', '情绪健康', '智力正常', '意志健全', '人格完整', 'B', 2, 0, 0, '2017-01-17 05:21:30'),
(27, '近年来，成为大学校园一大杀手的是_____。', '焦虑症', '疑病症', '恐怖症', '抑郁症', 'D', 2, 0, 0, '2017-01-17 05:21:30'),
(28, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:30'),
(29, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:31'),
(30, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:31'),
(31, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:31'),
(32, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:31'),
(33, '', '', '', '', '', '', 0, 0, 0, '2017-01-17 05:21:31');
...
(9, '你是属猪吗13', 4, 0, 0, 0, '2017-01-15 11:12:26'),
(10, '你是属猪吗27', 4, 0, 0, 0, '2017-01-15 11:12:26'),
(11, '你是属猪吗28', 4, 0, 0, 0, '2017-01-15 11:12:26'),
(12, '你是属猪吗29', 4, 0, 0, 0, '2017-01-15 11:12:27'),
(13, '你是属猪吗30', 4, 0, 0, 0, '2017-01-15 11:12:27'),
(14, '你是属猪吗31', 4, 0, 0, 0, '2017-01-15 11:12:27'),
(15, '你是属猪吗32', 4, 0, 0, 0, '2017-01-15 11:12:27'),
(16, '你是属猪吗33', 4, 0, 0, 0, '2017-01-15 11:12:27');
...
INSERT INTO `writing` (`id`, `topic`, `answer`, `fenzhi`, `time`) VALUES
(1, '就学生组织写一片论述', '哦', 0, '2017-01-01 16:00:38'),
(2, '就学生组织写一片论述drtfygu', '哦', 0, '2017-01-01 16:00:38'),
(3, '这是写作测试题目1', '这是写作测试答案1', 40, '2017-01-15 12:02:39'),
(4, '这是写作测试题目2', '这是写作测试答案2', 40, '2017-01-15 12:02:39'),
(5, '这是写作测试题目3', '这是写作测试答案3', 40, '2017-01-15 12:02:39'),
(6, '这是写作测试题目4', '这是写作测试答案4', 40, '2017-01-15 12:02:39'),
(7, '这是写作测试题目5', '这是写作测试答案5', 40, '2017-01-15 12:02:39'),
(8, '这是写作测试题目6', '这是写作测试答案6', 40, '2017-01-15 12:02:39'),
(9, '这是写作测试题目7', '这是写作测试答案7', 40, '2017-01-15 12:02:39'),
(10, '这是写作测试题目8', '这是写作测试答案8', 40, '2017-01-15 12:02:39'),
(11, '这是写作测试题目9', '这是写作测试答案9', 40, '2017-01-15 12:02:39'),
(12, '这是写作测试题目10', '这是写作测试答案10', 40, '2017-01-15 12:02:39'),
(13, '这是写作测试题目11', '这是写作测试答案11', 40, '2017-01-15 12:02:39'),
(14, '这是写作测试题目12', '这是写作测试答案12', 40, '2017-01-15 12:02:39'),
(15, '这是写作测试题目13', '这是写作测试答案13', 40, '2017-01-15 12:02:40'),
(16, '这是写作测试题目14', '这是写作测试答案14', 40, '2017-01-15 12:02:40'),
(17, '这是写作测试题目15', '这是写作测试答案15', 40, '2017-01-15 12:02:40'),
(18, '这是写作测试题目16', '这是写作测试答案16', 40, '2017-01-15 12:02:40'),
(19, '这是写作测试题目17', '这是写作测试答案17', 40, '2017-01-15 12:02:40'),
(20, '这是写作测试题目18', '这是写作测试答案18', 40, '2017-01-15 12:02:40'),
(21, '这是写作测试题目19', '这是写作测试答案19', 40, '2017-01-15 12:02:40'),
(22, '这是写作测试题目20', '这是写作测试答案20', 40, '2017-01-15 12:02:40'),
(23, '这是写作测试题目21', '这是写作测试答案21', 40, '2017-01-15 12:02:40'),
(24, '这是写作测试题目22', '这是写作测试答案22', 40, '2017-01-15 12:02:40'),
(25, '这是写作测试题目23', '这是写作测试答案23', 40, '2017-01-15 12:02:40'),
(26, '这是写作测试题目24', '这是写作测试答案24', 40, '2017-01-15 12:02:40'),
(27, '这是写作测试题目25', '这是写作测试答案25', 40, '2017-01-15 12:02:40'),
(28, '这是写作测试题目26', '这是写作测试答案26', 40, '2017-01-15 12:02:40'),
(29, '这是写作测试题目27', '这是写作测试答案27', 40, '2017-01-15 12:02:40'),
(30, '这是写作测试题目28', '这是写作测试答案28', 40, '2017-01-15 12:02:40'),
(31, '这是写作测试题目29', '这是写作测试答案29', 40, '2017-01-15 12:02:40'),
(32, '这是写作测试题目30', '这是写作测试答案30', 40, '2017-01-15 12:02:40'),
(33, '这是写作测试题目31', '这是写作测试答案31', 40, '2017-01-15 12:02:40'),
(34, '这是写作测试题目32', '这是写作测试答案32', 40, '2017-01-15 12:02:40'),
(35, '这是写作测试题目33', '这是写作测试答案33', 40, '2017-01-15 12:02:40');
